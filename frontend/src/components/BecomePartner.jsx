        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="max-w-2xl mb-8 md:mb-0">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Become a PharmaHealth Partner
            </h2>
            <p className="text-white/90 text-lg leading-relaxed">
              Are you a healthcare provider or pharmacy looking to partner with a reliable pharmaceutical supplier? 
              Join our network of partners for exclusive benefits, competitive pricing, and priority access to our products.
            </p>
          </div>
