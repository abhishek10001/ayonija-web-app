...
//             <h3 className="text-lg font-semibold mb-4">About Pinnacle</h3>
...
//               <li><a href="/policies" className="hover:text-blue-400">Policies, Reports & Filings</a></li>
//               <li><a href="/know-more" className="hover:text-blue-400">Know More</a></li>
//             </ul>
//           </div>
...
//             <ul className="space-y-2">
//               <li><a href="/research" className="hover:text-blue-400">Research and Development</a></li>
...
//             <ul className="space-y-2">
//               <li>Motherdrd Industrial Estate,</li>
//               <li>Ground Floor, Plot No. 1090, Road No. 29,</li>
//               <li>Sion(E), Mumbai-400022, India.</li>
//               <li>+91 (22) 24CJ9C025</li>
//               <li><a href="mailto:export.pinnacle@aartidrugs.com" className="hover:text-blue-400">export.pinnacle@aartidrugs.com</a></li>
//             </ul>
//           </div>

//           {/* Logo and Subsidiary Info */}
//           <div className="mb-8 md:mb-0">
//             <img src="/path-to-your-logo.png" alt="Pinnacle Life Science Logo" className="mb-4" />
//             <p className="text-sm">Subsidiary of A. Aarti Drugs Ltd.</p>
//             <p className="text-sm">Pinnacle Life Science - specialized CDMO and CMO services provider.</p>
//           </div>
//         </div>
...
//           <p className="text-sm">
//             &copy; 2025 Subsidiary Of Aarti Drugs Ltd. All rights reserved | Code and Design credits
//           </p>
//         </div>
//       </div>
//     </footer>
